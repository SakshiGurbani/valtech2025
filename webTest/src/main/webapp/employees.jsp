...
<form action="employees" method="get">
   ...
   <select id="searchBy" name="searchBy">
      ...
      <option value="greaterThanSalary">Greater than Salary</option>
      <option value="lessThanSalary">Less than Salary</option>
...
<table>
      ...
      <th ><a href="employees?operation=sorting&sortorder=${sortorder=='asc'?'desc':'asc'}&sortBy=deptId">DeptId</a></th>
      <th >Actions</th>
      </tr>
