...
public class MovieServer {
	...
	public static void main(String[] args) {
		...
		impl.addMovie(new Movie(2,"De dana dan","Hindi","Comdey",List.of("Akshay Kumar","Sunil Shetty","Paresh Rawal")));
		impl.addMovie(new Movie(3,"3 Idiots","Hindi","Comdey",List.of("Aamir Khan","Kareena Kapoor","Maddy")));
		impl.addMovie(new Movie(4,"Alaipaydhey","Tamil","Drama",List.of("Madhavan","Shalini")));
		impl.addMovie(new Movie(5,"Nayagan","Tamil","Dranma",List.of("Kamal Hassan","Sharanya")));
