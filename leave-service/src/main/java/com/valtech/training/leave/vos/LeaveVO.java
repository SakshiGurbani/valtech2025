...
public record LeaveVO(long id,String fromDate,String toDate,String leaveType,String leaveStatus,String
		reason,
	...
	public static LeaveVO from(Leave leave) {
		...
		return new LeaveVO(leave.getId(),from,to,ltype,lstatus,leave.getResaon(),leave.getComments()
				,leave.getEmployeeId());
	}
