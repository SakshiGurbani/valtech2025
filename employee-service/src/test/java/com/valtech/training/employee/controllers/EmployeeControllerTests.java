	...
	void addEmployees() {
		...
		if(emps.size()==0) {
			...
			EmployeeVO manager1=restTemplate.postForObject("http://localhost:"+port+"/api/v1/employees/", 
					new EmployeeVO(0,"Def",456456456,"def@gmail.com",manager.id()),EmployeeVO.class);
			EmployeeVO emp1=restTemplate.postForObject("http://localhost:"+port+"/api/v1/employees/", 
					new EmployeeVO(0,"Pqr",234234234,"pqr@gmail.com",manager1.id()),EmployeeVO.class);
			...
			EmployeeVO emp3=restTemplate.postForObject("http://localhost:"+port+"/api/v1/employees/", 
					new EmployeeVO(0,"Lmn",789789789,"lmn@gmail.com",manager1.id()),EmployeeVO.class);
		}
