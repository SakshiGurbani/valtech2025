...
public class Customer {
	...
	//mapped by is the field on the child(address) where join column definition is declared
	...
	public void addAccount(Account ac) {
		...
		accounts.add(ac);
		if(ac.getCustomer()==null) ac.setCustomer(new HashSet<Customer>());
		ac.getCustomer().add(this);
	}
	
	public void removeAccount(Account ac) {
		accounts.remove(ac);
		ac.getCustomer().remove(null);
	}
